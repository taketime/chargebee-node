...
(function() {
    ...
    // return object that does all the cbee stuff, but can have separate instances
    function cbee(site, apiKey) {
        this._env = {
            protocol: 'https',
            hostSuffix: '.chargebee.com',
            apiPath: '/api/v1',
        ...
        for (var res in ChargeBee._endpoints) {
            ...
            for (var apiIdx = 0; apiIdx < apiCalls.length; apiIdx++) {
                ...
                var apiCall = {"methodName": metaArr[0],
                    ...
                    "urlSuffix": metaArr[3],
                    "hasIdInUrl": metaArr[4]};
                this[res][apiCall.methodName] = createApiFunc(apiCall);
            }
        }
